...
public class ActualizarNombreProductoUseCase {
    ...
    public ActualizarNombreProductoUseCase(FranquiciaRepositoryPort franquiciaRepositoryPort) {
        // dependo del puerto para mantener Clean Architecture
        this.franquiciaRepositoryPort = franquiciaRepositoryPort;
    }

    public Mono<Void> execute(String franquiciaId, String sucursalId, String productoId, String nuevoNombre) {
        // busco franquicia
        // busco sucursal
        // busco producto
        // cambio nombre
